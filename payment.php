...
--This is the php file which show the options for payment after completing the order and checkout after the calculation of total price-->
<?php
session_start();
...
<!--Heading of the website-->
  <head>
    <title> Cart | Just Eat' </title>
  </head>
<!--Connecting with the css and javscript files-->
...
?>
 ...
 <?php
 //This for checking the items in the cart and after that it will insert the items in the cart to the database table
$gtotal = 0;
    ...
    $gtotal = $gtotal + $total;
     ...
     $query = "INSERT INTO ORDERS (F_ID, foodname, price,  quantity, order_date, username, R_ID) 
      ...
      if(!$success)
      {
        ...
        ?>
        <!--This is the option where you can choose your payment option and it is the main part of the body-->
        <div class="container">
          <div class="jumbotron">
