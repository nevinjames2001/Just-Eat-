...
--This is the php file which is used for add to cart function which add the items customer select and to to get the total price of items-->
<?php
session_start();
...
<html>
 ...
 <!--Connecting with the css and javascript files-->
...
if(!empty($_SESSION["cart"]))
{
  ...
  <div class="container">
    ...
    <!--Table creation for the display of food items and total price of it-->
...
<!--Button to empty the cart,continue shopping and to checkout-->
<?php
...
{
  ?>
  <!--Message to display if nothing is there on cart-->
  <div class="container">
      <div class="jumbotron">
        <h1>Your Shopping Cart</h1>
...
<!--Getting all the food items and their price from the database according to the customer's selection-->
<?php
