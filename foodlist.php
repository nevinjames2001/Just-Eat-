...
--This is the php main file which displays the food items list and the details-->
<?php
session_start();
...
<!--Slideshow of photos of diifferent foood items-->
...
?>
<!--This is the main body part which diaplays the food items list-->
<div class="col-md-3">
