...
--This is the php file which gives the customers to enter the details for contacting them -->
<?php
session_start();
?>
...
?>
    ...
    <div class="heading">
     <strong>Want to contact <span class="edit"> Just Eat' </span>?</strong>
     <br>
    Here are a few ways to get in touch with us.
    </div>

    <div class="col-xs-12 line"><hr></div>
<!--Form to enter the details to contact the customers-->
    <div class="container" >
...
//Inserting these details into the database
