...
--This is the php file which helps to complete the payement by online by entering the credit card number and other detials-->
<?php
session_start();
...
<!--Heading of the website-->
  <head>
    <title> Online Payment | Just Eat' </title>
  </head>
...
<!--Form to fill the details for the card payment method-->
<div class="container">
    <div class="row">
        <div class="jumbotron">
