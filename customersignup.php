...
--This is the php file which to show customer's signup page to create an new account-->
<html>
<head>
    <title> Guest Signup | Just Eat' </title>
  </head>
  ...
  <!--This functions guides the customer to scroll up to the top of page-->
...
<!--This is the header of the website-->
    ...
    <div class="container">
    <div class="jumbotron">
     <h1>Hi Guest, <br> Welcome to <span class="edit"> Just Eat' </span></h1>
     <br>
...
<!--Form to fill the details to create  an new account-->
    <div class="container" style="margin-top: 4%; margin-bottom: 2%;">
      ...
      <div class="panel panel-primary">
        ...
        <!--To guide the customers who have their own account to login into their account-->
