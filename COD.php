...
--This is the php file which to show after the payment method is completed-->
<?php
session_start();
...
<h2 class="text-center"> Thank you for Ordering at Just Eat'! The ordering process is now complete.</h2>
