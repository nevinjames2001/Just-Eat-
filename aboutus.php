...
--This is the php file which explains about the details of Just eat website -->
<?php
session_start();
?>
...
<html>
  ...
  <body>
 <!--This is the button which guides the customer's look or to got the top of page-->
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top navigation-clean-search" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">Just Eat'</a>
        </div>
...
<!--Body part of the website-->
    <div class="wide">
        ...
        <h3 style="color: red">About the food culture in Just Eat'</h3>
        <br>
      ...
      <iframe src=https://www.google.com/maps/place/barBURRITO/@43.2374397,-79.8856817,15z/data=!4m8!1m2!2m1!1sJust+Eat!3m4!1s0x0:0xe39834a18d2e55d4!8m2!3d43.2380416!4d-79.8779923" style="width: 250px"></iframe>
         </body>
</html>